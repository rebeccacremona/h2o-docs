...
gemfile_to_container: up
	docker cp build-environment/Gemfile h2o-docs_jekyll_1:/usr/src/h2o-docs/Gemfile

gemfile_lock_from_container: up
	docker cp h2o-docs_jekyll_1:/usr/src/h2o-docs/Gemfile.lock build-environment/Gemfile.lock
